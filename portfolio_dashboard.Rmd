...
###
```{r}
div(style="display: inline-block;vertical-align:top; width: 100px; height: 22px",paste('Benchmark:'))
div(style="display: inline-block;vertical-align:top; width: 100px; height: 22px",selectInput('benchmark_id', NULL, choices =  c('SPY', 'SHY', 'IWM', 'BND', 'VT'), selectize = FALSE, size = 1))
```
